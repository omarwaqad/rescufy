...
export default function CriticalRequestCard() {
  ...
  return (
    <motion.article
      className="relative overflow-hidden rounded-2xl border border-red-500/10 bg-bg-card/80 px-1 py-4 text-heading shadow-card"
    ...
    >
      ...
      <div className="flex flex-col gap-2 px-3">
        <div className="flex items-center justify-between gap-2 text-xs text-muted">
          ...
          <motion.span
            className="critical-gradient rounded-full px-2 py-0.5 text-[10px] font-semibold text-white"
        ...
        <h3 className="text-sm font-semibold leading-tight text-heading">Ahmed Hassan</h3>

        <p className="max-w-xl text-xs text-muted">Severe chest pain, difficulty breathing</p>
