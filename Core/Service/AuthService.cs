...
namespace Service
{
        ...
        : IAuthService
    {
        ...
        public async Task<AuthResult> LoginAsync(LoginRequest request)
        {
            ...
            {
                return new AuthResult { Succeeded = false, Message = localizer[SharedResourcesKeys.EmailNotConfirmed] };
            }
        ...
        private async Task<string> GenerateJwtTokenAsync(ApplicationUser user)
        {
            ...
            {
                authClaims.Add(new Claim("HospitalId", user.HospitalId.Value.ToString()));
            }

            if (user.AssignedAmbulanceId.HasValue)
            {
                authClaims.Add(new Claim("AmbulanceId", user.AssignedAmbulanceId.Value.ToString()));
            }
