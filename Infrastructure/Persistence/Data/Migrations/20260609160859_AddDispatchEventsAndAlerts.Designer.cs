...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20260609160859_AddDispatchEventsAndAlerts")]
    partial class AddDispatchEventsAndAlerts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Ambulance", b =>
                {
                    ...
                    b.Property<int?>("AmbulancePointId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AmbulanceNumber")
                        .IsUnique();

                    b.HasIndex("AmbulancePointId");
            ...
            modelBuilder.Entity("Domain.Models.AmbulancePoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AmbulancePoints", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.DispatchAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DispatchAlerts");
                });

            modelBuilder.Entity("Domain.Models.DriverFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Hospital", b =>
                {
                    ...
                    b.Property<int>("AcceptedRequests")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.HospitalFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HospitalFeedbacks", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.ParamedicFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ParamedicFeedbacks", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Request", b =>
                {
                    ...
                    b.Property<bool>("IsAdminIntervention")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Models.RequestEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.TripReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MedicalProcedures")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.Ambulance", b =>
                {
                    b.HasOne("Domain.Models.AmbulancePoint", "AmbulancePoint")
                        .WithMany("Ambulances")
                        .HasForeignKey("AmbulancePointId")
                    ...
                    b.HasOne("Domain.Models.ApplicationUser", "Paramedic")
                        .WithMany()
                        .HasForeignKey("ParamedicId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("AmbulancePoint");
            ...
            modelBuilder.Entity("Domain.Models.ApplicationUser", b =>
                {
                    b.HasOne("Domain.Models.Ambulance", "AssignedAmbulance")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.TripReport", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Request", "Request")
                        .WithOne("TripReport")
                        .HasForeignKey("Domain.Models.TripReport", "RequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
